                ...
                <div class="card-body">
                    ...
                    <form method="post">
                        <div class="row">
                            <div class="col-12 col-md-8 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="softwareTitle" required>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for="">Software Price</label>
                                    <input type="text" class="form-control" name="softwarePrice" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="softwareDescription" rows="10" required></textarea>
                        </div>
